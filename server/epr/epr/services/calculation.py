...
def risk_dict_constructor(complication: str, risk_results: dict, language_code: str) -> dict:
    ...
    return {"complication": translated_comp, "severity_str": severity_string, "severity": risk_results["severity"], 
            "risk_str": "{} {}".format(risk_results["percent"], percentage_translated), "risk_score": risk_results["risk"], "risk_percent": risk_results["percent"]}
